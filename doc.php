                    ...
                    <div id="collapseDescripcion" class="accordion-collapse collapse" data-bs-parent="#docAccordion">
                        <div class="accordion-body">
                            ...
                            <ul>
                                ...
                                <li>Registro de cambios usuarios<span class="badge bg-secondary">Por implementar</span></li>
                                <li>Registro de ventas<span class="badge bg-secondary">Por implementar</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div id="collapseEstructura" class="accordion-collapse collapse" data-bs-parent="#docAccordion">
                        <div class="accordion-body">
                            <ul>
                                ...
                                <li>
                                    <b>Año:</b>
                                    Categoriza modelos por año/generación. Útil para buscar productos recientes.</li>
                                <li>
                                    <b>Modelo:</b>
                    ...
                    <div id="collapseFuncionalidades" class="accordion-collapse collapse" data-bs-parent="#docAccordion">
                        <div class="accordion-body">
                            <ul>
                                ...
                                <li>
                                    <b>Administrar:</b>
                                    Cambia la base de datos y usuarios.
                                    <ul>
