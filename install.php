    ...
    if ($step == 'db') {
        ...
        if (!$conn) {
            ...
            $sqls = [
                ...
                "CREATE TABLE IF NOT EXISTS `stock` ( `idStock` int(11) NOT NULL AUTO_INCREMENT, `refModel` int(6) NOT NULL, `refTipo` int(2) NOT NULL, `refColor` int(2) NOT NULL, `stock` int(2) NOT NULL, `usarRel` tinyint(1) NOT NULL DEFAULT 0, `idMarca` int(11) NOT NULL, `idRel` int(11) NOT NULL, `modificado` date DEFAULT NULL, PRIMARY KEY (`idStock`) ) ENGINE=InnoDB;",
