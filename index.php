        ...
        <main>
            <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            if (mysqli_num_rows($result) == 0) {
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    echo "<button type=button value=" . $row['idMarca'] . " class=' btn btn-secondary botonListadoMarcas'>" . $row['refMarca'] . " - " . $row['nombreMarca'] . "</button>";
                            ...
                            <div class="modal fade" id="editarMarcaModal" tabindex="-1"
                                aria-labelledby="editarMarcaModalLabel" aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form id="formEditarMarca">
                                                ...
                                                <div class="mb-3">
                                                    <label for="nombreMarca" class="form-label">Nombre de la
                                                        Marca</label>
                                                    <input type="text" class="form-control" id="nombreMarca"
                                                        name="nombreMarca" required>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="refMarca" class="form-label">Referencia de la
                                                        Marca</label>
                                                    <input type="text" class="form-control" id="refMarca"
                                                        name="refMarca" required>
                                                </div>
                                            </form>
                                        </div>
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-primary"
                                                id="guardarCambiosMarca">Guardar cambios</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            if (mysqli_num_rows($result) == 0) {
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    echo "<li class='list-group-item list-group-item-action'>";
                                    echo "<button type=button value=" . $row['idYear'] . " class='btn btn-secondary botonListadoYear'>" . $row['year'] . "</button>";
                    ...
                    <!-- Modal editar Año -->
                    <div class="modal fade" id="editarYearModal" tabindex="-1" aria-labelledby="editarYearModalLabel"
                        aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="editarYearModalLabel">Editar Año</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <form id="formEditarYear">
                                        <input type="hidden" id="idYear" name="idYear">
                                        <div class="mb-3">
                                            <label for="yearName" class="form-label">Nombre del Año</label>
                                            <input type="text" class="form-control" id="yearName" name="yearName" required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="refYear" class="form-label">Referencia</label>
                                            <input type="text" class="form-control" id="refYear" name="refYear"
                                                required>
                                        </div>
                                    </form>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary"
                                        data-bs-dismiss="modal">Cerrar</button>
                                    <button type="button" class="btn btn-primary" id="guardarCambiosYear">Guardar
                                        cambios</button>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-4">
                    ...
                    <!-- Modal editar Modelo -->
                    <div class="modal fade" id="editarModeloModal" tabindex="-1"
                        aria-labelledby="editarModeloModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <form id="formEditarModelo">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="nombreModelo"
                                                name="nombreModelo" required>
                                        <label for="refModelo" class="form-label">Referencia</label>
                                            <input type="text" class="form-control" id="refModelo" name="refModelo"
                                                required>
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary"
                                        data-bs-dismiss="modal">Cerrar</button>
                                    <button type="button" class="btn btn-primary" id="guardarCambiosModelo">Guardar
                                        cambios</button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            if (mysqli_num_rows($result) == 0) {
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    echo "<li class='list-group-item'>" . $row['nombreTipo'] . " - " . $row['pvp'] . "<div> "
                            ...
                            <div class="modal fade" id="editarTipoModal" tabindex="-1"
                                aria-labelledby="editarTipoModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <form id="formEditarTipo">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="nombreTipo"
                                                        name="nombreTipo">
                                                    <label for="refTipo" class="form-label">Referencia</label>
                                                    <input type="text" class="form-control" id="refTipo" name="refTipo">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary"
                                                data-bs-dismiss="modal">Cerrar</button>
                                            <button type="button" id="guardarCambiosTipo"
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="modal fade" id="editarColorModal" tabindex="-1"
                                aria-labelledby="editarColorModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <form id="formEditarColor">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="nombreColor"
                                                        name="nombreColor">
                                                    <label for="refColor" class="form-label">Referencia</label>
                                                    <input type="text" class="form-control" id="refColor" name="refColor">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="thumb" class="form-label">thumb</label>
                                                    <input type="color" class="form-control" id="thumb" name="thumb">
                                                </div>
                                            </form>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary"
                                                data-bs-dismiss="modal">Cerrar</button>
                                            <button type="button" id="guardarCambiosColor"
                                                class="btn btn-primary">Guardar Cambios</button>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body" id="GrupoRelacionados">
                            ...
                            echo Relacionados::get_relaciones();
                            ?>
                            </div>
                            <a href="opciones.php" class="btn btn-primary">Añadir</a>
                        </div>
