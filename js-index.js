...
document.addEventListener("DOMContentLoaded", function () {
                ...
                body: 'idTipoEditar=' + encodeURIComponent(idTipo)
                    ...
                    .then(data => {
                        if (data.error) {
                            ...
                            var myModal = new bootstrap.Modal(document.getElementById('editarTipoModal'));
                            myModal.show();
                        }
                    });
        });
                ...
                body: 'idColorEditar=' + encodeURIComponent(idTipo)
                    ...
                    .then(data => {
                        if (data.error) {
                            ...
                            var myModal = new bootstrap.Modal(document.getElementById('editarColorModal'));
                            myModal.show();
                        }
                    });
        });
    });
    document.getElementById("guardarCambiosMarca").addEventListener("click", function () {
        var formData = new URLSearchParams(new FormData(document.getElementById('formEditarMarca'))).toString();
    ...
    document.getElementById("guardarCambiosModelo").addEventListener("click", function () {
        var formData = new URLSearchParams(new FormData(document.getElementById('formEditarModelo'))).toString();
        console.log("Datos enviados:", formData);  // Verifica los datos que se envían
    ...
    document.getElementById("guardarCambiosTipo").addEventListener("click", function () {
        var formData = new URLSearchParams(new FormData(document.getElementById('formEditarTipo'))).toString();
        console.log("Datos enviados:", formData);  // Verifica los datos que se envían
    ...
    document.getElementById("guardarCambiosColor").addEventListener("click", function () {
        var formData = new URLSearchParams(new FormData(document.getElementById('formEditarColor'))).toString();
        console.log("Datos enviados:", formData);  // Verifica los datos que se envían
