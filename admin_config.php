        ...
        <div
            ...
            <div class="mt-5 row justify-content-md-center">
                ...
                <?php if (isset($_SESSION['admin_user']) && isset($_SESSION['admin_id'])) { ?>
                        <div class="mb-2"> Conectado como
                        <b><?php echo htmlspecialchars($_SESSION['admin_user']); ?></b>
                        <a href="?logout=1" class="btn btn-sm btn-outline-danger ms-2">Cerrar sesión</a>
                    </div>
                    <div class="col-6 align-self-center">
                        <ul
                            class="nav nav-tabs mb-3" id="adminTab" role="tablist">
                            ...
                            <?php } ?>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link<?php if ($_SESSION['admin_id'] != 1)
                                    echo ' active'; ?>" id="self-tab" data-bs-toggle="tab" data-bs-target="#self" type="button" role="tab" aria-controls="self" aria-selected="false">Mi cuenta</button>
                            </li>
                        </ul>
                        <div
                            class="tab-content" id="adminTabContent">
                            <?php if ($_SESSION['admin_id'] == 1) { ?>
                                ...
                                <div
                                    class="tab-pane fade p-3" id="list" role="tabpanel" aria-labelledby="list-tab"><?php
                            ...
                            <?php } ?>
                            <div class="tab-pane fade<?php if ($_SESSION['admin_id'] != 1)
                                echo ' show active'; ?> p-3" id="self" role="tabpanel" aria-labelledby="self-tab">
                                <form method="post">
